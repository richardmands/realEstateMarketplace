...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        _owner = newOwner;
        emit HasNewOwner(_owner);
    }

    //  5) create an event that emits anytime ownerShip is transfered (including in the constructor)
    event HasNewOwner(address newOwner);
}
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(_tokenOwner[tokenId] == msg.sender || isApprovedForAll(_tokenOwner[tokenId], msg.sender));
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    constructor (string memory _name, string memory _symbol, string memory baseTokenURI) public {
...
contract CustomERC721Token is ERC721Metadata ("Capstone", "RMN", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
